...
import static http.AppHttpServer.PASSWORD;
import static http.AppHttpServer.USERNAME;
...
public class HttpClientt {
    ...
    public List<Category> getAllCategories() {
        HttpURLConnection connection = new HttpClientt().getConnection("/categories", HttpMethod.GET);
    ...
    public void addProductToCart(Product product) {
        ObjectMapper mapper = new ObjectMapper();
        HttpURLConnection connection = new HttpClientt().getConnection("/cart", HttpMethod.POST);
